...
namespace Trade.WebAPI.Controllers
{
    ...
    public class OrdersController : ApiController
    {
        ...
        public IHttpActionResult UpdateOrderStatus(int id, [FromBody] order orderData)
        {
            ...
            // 1. Меняем статус заказа (например, "Новый" -> "Доставлен")
            ...
            // Бывает, что менеджер меняет статус, но дату не трогает.
            // Поэтому проверяем: если дата пришла (не null), то обновляем.
